...
public class EleveGomGUI {
    ...
    public static void DeleteEleveGomWithIdEleveGUI(String idEleve) throws IOException, TemplateException {
    ...
    public static String createEleveGomGUI(Request req, String idEleve, String idGom) throws IOException, TemplateException {
        Configuration configuration = _FreeMarkerInitializer.getContext();
    ...
    public static String deleteEleveGomGUI() throws IOException, TemplateException {
        Configuration configuration = _FreeMarkerInitializer.getContext();
