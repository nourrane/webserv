...
public class EleveGUI {
    ...
    public static String getAllElevesModify(Request req) throws IOException, TemplateException {
        Configuration configuration = _FreeMarkerInitializer.getContext();
    ...
    public static String getAllElevesDelete(Request req) throws IOException, TemplateException {
        Configuration configuration = _FreeMarkerInitializer.getContext();
